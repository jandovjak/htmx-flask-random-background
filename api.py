...
def scale_image(image, scale_width, scale_height):
    ...
    for i in range(image.width):
        for j in range(image.height):
            new_image = fill_image(new_image, i * scale_width, j * scale_height, scale_width, scale_height, image.getpixel((i,j)))
    return new_image
...
def download():
    ...
    encoded_image = 'iVBORw0KGgoAAAANSUhEUgAAAAkAAAABCAIAAACDoBMqAAAAJUlEQVR4nGMUNTNS1zqUfK38XsfvOVdfSpRbhR29HNDMpNP3FwCuDg1A8jNqlQAAAABJRU5ErkJggg=='
